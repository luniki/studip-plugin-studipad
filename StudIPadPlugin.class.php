...
class StudIPadPlugin extends StudipPlugin implements StandardPlugin
{
	...
	//INSERTED EL 02.12.2014
	function getReadOnlyStatus($padid){
		$db = DBManager::get();
    ...
    function getControlSet($padid, $control){
		$db = DBManager::get();
    ...
    function setControlSet($padid, $padname, $controlset, $readonly) {
    	$db = DBManager::get();
	...
	function getHtmlControlString($padid) {
