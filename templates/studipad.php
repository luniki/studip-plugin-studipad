...
if (!isset($padurl)) {
	...
	if (isset($tpads)) { ?>
		...
		?>
				...
				<td align="center">
				<?
				    //CHANGED TO ICON EL 11.12.2014
                                    
				    echo "<a id=\"start$padid\" href=\"".PluginEngine::getLink('studipadplugin',array('action' => 'open' , 'pad' => $padid))."\" target=\"_blank\">".Assets::img("icons/16/blue/door-enter")."</a>";
				?>
				</td>
		...
		<? //Adminbereich in einer eigenen Table und fÃ¼r jedes Element wird eine Form ausgegeben
			if (isset($padadmin) && ($padadmin)){
...
//			       'kategorie' => dgettext('studipad','Information'),
//			       'eintrag'   => array(array(
//							  'text' => '<a href="http://elearningblog.tugraz.at/archives/3493" target="_blank">'.
//							  dgettext('studipad','Kurzes Demo-Video: So funktioniert Etherpad').'</a>'
//							  
//							  ))
//			       ));
//
//$infobox = array('picture' => 'infobox/seminars.jpg', 'content' => $infobox_content);
?>
